...
import { Button, Input, cn } from '@kortix/nuxt-ui'
...
const description = computed(() =>
  method.value === 'magic' ? 'We will email you a secure sign-in link' : 'Email and password is all you need',
)
...
async function onSubmit() {
  ...
  if (method.value === 'magic') {
    info.value = "Magic links aren't available in this gallery build — use a password to create your account instead."
    return
  }
...
<template>
  <AuthShell mode="register" title="Create your account" :description="description">
